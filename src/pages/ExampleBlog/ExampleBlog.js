...
const text = (
  <p>
    De branding, ook wel identiteit genoemd, van je bedrijf begint met een goed
    logo, maar dat is natuurlijk niet zo vanzelfsprekend als het klinkt. Een
    goed logo is simpel, herkenbaar, tijdloos, veelzijdig en relevant. Je voelt
    het al, er komt meer bij kijken dan je op het eerste zicht zou denken.
    <br />
    <br />
    <div style={{ textAlign: "right" }}>- April 2020 - Aline De Lombaerde</div>
  </p>
);
  ...
  return (
    <>
      <Header
        ...
        scrollTo={myRef}
      />
      <main className="example-blog" ref={myRef}>
        <div className="container">
          <h2 className="heading-2">Simpel</h2>
          <p>
          ...
          <img
            className="example-blog__img example-blog__amazon"
            src={Amazon}
            alt="Amazon Logo"
          />
          <h2 className="heading-2">Herkenbaar</h2>
          <p>
          ...
          <h2 className="heading-2">Tijdloos</h2>
          <p>
          ...
          <img
            className="example-blog__img example-blog__pepsi"
            alt="Cocacola vs Pepsi logo"
            src={Pepsi}
          />
          <p>
          ...
          <h2 className="heading-2">Veelzijdig</h2>
          <p>
            ...
            <ul>
              ...
              <li>
                Is mijn logo nog leesbaar & herkenbaar als het zeer klein
                gedrukt is
              </li>
              <li>
          ...
          <h2 className="heading-2">Relevant</h2>
          <p>
          ...
          <h2 className="heading-2">Prijskaartje</h2>
          <p>
          ...
          <h2 className="heading-2">Ontwerp proces</h2>
          <p>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Is het logo geschikt voor de sector waarin we ons bevinden
              </li>
              <li>Is het logo simpel, niet te ingewikkeld</li>
              <li>Draagt het logo een duidelijke boodschap</li>
              <li>
                Is het logo leesbaar, herkenbaar en makkelijk te onthouden
              </li>
              ...
              <li>
                Kan je het logo zowel in kleur als in zwart-wit gebruiken?
              </li>
            </ul>
          </p>
        </div>
